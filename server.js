    ...
    if(currentEvent.T === "n") { // This is a news event
        ...
        const apiRequestBody = {
            ...
            "messages": [
                ...
                { role: "user", content: "Given the headline '"+ currentEvent.headline + "' , and the description '" + currentEvent.content + "', show me a number from 1-100 detailing the impact of this headline."}
            ]
        }
